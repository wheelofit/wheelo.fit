      ...
      >
        ...
        >
          <div style={{ display: "flex", flexDirection: "column" }}>
            ...
            <div
              style={{
                background: "#f5f4ef",
                borderRadius: cycle.isInstock ? "16px" : "0 0 16px 16px",
                padding: "2rem",
                position: "relative",
                display: "flex",
                flexDirection: "column",
            ...
            >
              ...
              >
                ...
                {cycle.pricing && cycle.pricing.length > 0
                  ? cycle.pricing.find(
                      (p) => p.durationLabel?.toLowerCase() === "1 month",
                    )?.price || Math.max(...cycle.pricing.map((p) => p.price))
                  : "---"}
                /mo
              </span>
            </div>
            {cycle.isInstock ? (
              <button
                ...
                style={{
                  ...
                  padding: "1rem",
                  background:
                    "linear-gradient(135deg, #e3ff00 0%, #a3e600 100%)",
                  color: "#000",
                  fontSize: "1.1rem",
                  fontWeight: "bold",
                  border: "none",
        ...
        >
          <div className="desktop-form-container">
            ...
            <RentalBookingForm cycles={[cycle]} preselectedCycleId={cycle.id} />
          </div>
          ...
          >
            ...
            >
              <div style={{ display: "flex", alignItems: "flex-start" }}>
                <div style={{ flex: "0 0 130px", color: "#888" }}>Speed</div>
                <div style={{ flex: 1, color: "#fff", fontWeight: "600" }}>
                  {cycle.speed || "Single Speed"}
                </div>
              </div>
              <div style={{ display: "flex", alignItems: "flex-start" }}>
                <div style={{ flex: "0 0 130px", color: "#888" }}>Brakes</div>
                <div style={{ flex: 1, color: "#fff", fontWeight: "600" }}>
                  {cycle.brakes || "Power"}
                </div>
              </div>
              <div style={{ display: "flex", alignItems: "flex-start" }}>
                <div style={{ flex: "0 0 130px", color: "#888" }}>
                  Tyre Size
                </div>
                <div
                  style={{
                ...
                >
                  {cycle.tyreSize || "24 Inches"}
                </div>
              </div>
              <div style={{ display: "flex", alignItems: "flex-start" }}>
                <div style={{ flex: "0 0 130px", color: "#888" }}>Seat</div>
                <div style={{ flex: 1, color: "#fff", fontWeight: "600" }}>
                  Adjustable
                </div>
              </div>
          ...
          >
            ...
            >
              *Actual cycle may differ from the photo
              <br />
              *Please go through our FAQs before availing any of our services.
              By subscribing to WheelO you are adhering to all our Terms &
